...
def get_dpcode(
    device: TuyaDevice, dpcodes: str | DPCode | tuple[DPCode, ...] | None
) -> DPCode | None:
...
def get_dptype(
    device: TuyaDevice, dpcode: DPCode | None, *, prefer_function: bool = False
) -> DPType | None:
...
class ActionDPCodeNotFoundError(ServiceValidationError):
    ...
    def __init__(
        self, device: TuyaDevice, expected: str | DPCode | tuple[DPCode, ...] | None
    ) -> None:
