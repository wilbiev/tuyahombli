...
class DPCodeWrapper(ABC):
    ...
    def _read_device_status_raw(self, device: TuyaDevice) -> Any | None:
    ...
    @abstractmethod
    def read_device_status(self, device: TuyaDevice) -> Any | None:
        """Read the device value for the dpcode.

        The raw device status is converted to a Home Assistant value.
        """

    def _convert_value_to_raw_value(self, device: TuyaDevice, value: Any) -> Any:
    ...
    def get_update_command(self, device: TuyaDevice, value: Any) -> dict[str, Any]:
...
class DPCodeBase64Wrapper(DPCodeTypeInformationWrapper[TypeInformation]):
    ...
    def read_bytes(self, device: TuyaDevice) -> bytes | None:
        """Read the device value for the dpcode."""
...
class DPCodeBooleanWrapper(DPCodeTypeInformationWrapper[TypeInformation]):
    ...
    def read_device_status(self, device: TuyaDevice) -> bool | None:
        """Read the device value for the dpcode."""
...
class DPCodeJsonWrapper(DPCodeTypeInformationWrapper[TypeInformation]):
    ...
    def read_json(self, device: TuyaDevice) -> Any | None:
        """Read the device value for the dpcode."""
...
class DPCodeEnumWrapper(DPCodeTypeInformationWrapper[EnumTypeData]):
    ...
    def read_device_status(self, device: TuyaDevice) -> str | None:
        """Read the device value for the dpcode.
...
class DPCodeIntegerWrapper(DPCodeTypeInformationWrapper[IntegerTypeData]):
    ...
    def read_device_status(self, device: TuyaDevice) -> float | None:
        """Read the device value for the dpcode.
